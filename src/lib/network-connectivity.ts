...
function target(region: ConnectivityRegionId, id: string, name: string, domain: string, url = `https://${domain}/robots.txt`): ConnectivityTarget {
...
export const CONNECTIVITY_TARGETS: ConnectivityTarget[] = [
  ...
  target("us", "claude", "Claude", "claude.ai"),
  target("us", "chatgpt", "ChatGPT", "chatgpt.com", "https://chatgpt.com/cdn-cgi/trace"),
  target("us", "ai-studio", "AI Studio", "aistudio.google.com"),
  target("us", "amazon", "Amazon", "www.amazon.com"),
  target("us", "bing", "Bing", "www.bing.com"),
  target("us", "steam", "Steam", "store.steampowered.com"),
  target("us", "oracle", "Oracle", "www.oracle.com"),
  target("us", "zoom", "Zoom", "zoom.us"),
  target("us", "facebook", "Facebook", "www.facebook.com"),
  target("us", "instagram", "Instagram", "www.instagram.com"),
  target("us", "x", "X", "x.com"),
  target("us", "reddit", "Reddit", "www.reddit.com"),
  target("us", "linkedin", "LinkedIn", "www.linkedin.com"),
  target("us", "twitch", "Twitch", "www.twitch.tv"),
  target("us", "netflix", "Netflix", "www.netflix.com"),
  ...
  target("global", "takealot", "Takealot", "www.takealot.com"),
  target("global", "pixpix", "PixPix", "www.pixpix.com"),
  target("global", "naver", "Naver", "www.naver.com"),
  target("global", "noon", "Noon", "www.noon.com"),
  target("global", "wikipedia", "Wikipedia", "www.wikipedia.org"),
  target("global", "bbc", "BBC", "www.bbc.com"),
  target("global", "mistral", "Mistral AI", "mistral.ai"),
  target("global", "yandex", "Yandex", "yandex.com"),
  target("global", "mercado-libre", "MercadoLibre", "www.mercadolibre.com"),
]
